...
export class UserService {
  ...
  private users = {
    ...
    Salma :{ name:'Salma Zaki', picture:'assets/images/salmazaki.jpg', Description:'I wanted to be an astronaut'},
    ...
    OmarHany: { name: 'Omar Hany', picture: 'assets/images/OmarHany.jpg', Description : 'I love crossfit'},
    NourNounou: { name: 'Nour Nounou', picture: 'assets/images/NourNounou.JPG', Description : 'I love SE'},
    EbramIbrahim: { name: 'Ebram Ibrahim', picture: 'assets/images/EbramIbrahim.jpg', Description : 'I love reading'},
    AhmedAlaa: { name: 'Ahmed Alaa', picture: 'assets/images/AhmedAlaa.jpg', Description : 'I love diving'},
    AhmedHany: { name: 'Ahmed Hany', picture: 'assets/images/AhmedHany.jpg',Description : 'I am a writer'},
  };
